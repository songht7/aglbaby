...
class Medical_Doctor_Icon_Selector extends WP_Customize_Control{
      public $type = 'icon';
            ...
            <label>
                  ...
                  <ul class="icon-list">
                      <div class="social-icon-search">
                          <input class="socialInput" type="text" placeholder="<?php echo esc_attr('Search Icon', 'medical-doctor'); ?>">
                      </div>
                    <?php
                    $medical_doctor_font_awesome_icon_array = medical_doctor_font_awesome_icon_array();
                    foreach ($medical_doctor_font_awesome_icon_array as $medical_doctor_font_awesome_icon) {
                            $icon_class = $this->value() == $medical_doctor_font_awesome_icon ? 'icon-active' : '';
                            echo '<li class='.esc_attr($icon_class).'><i class="'.esc_attr($medical_doctor_font_awesome_icon).'"></i>
                            <span class="medical-doctor-social-class">'.esc_attr($medical_doctor_font_awesome_icon).'</span>
                            </li>';
                        }
                    ?>
                  </ul>
...
function medical_doctor_customizer_script() {
     
    wp_enqueue_style( 'font-awesome-1', esc_url(get_template_directory_uri()).'/css/fontawesome-all.css');
}
add_action( 'customize_controls_enqueue_scripts', 'medical_doctor_customizer_script' );

if(!function_exists('medical_doctor_font_awesome_icon_array')){
    function medical_doctor_font_awesome_icon_array(){
